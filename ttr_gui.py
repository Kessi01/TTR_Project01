...
class FullscreenKeyboardPage(QWidget):
    ...
    def _position_suggestions_overlay(self):
        ...
        Zeilen sichtbar), damit die Auf/Ab-Buttons genau auf Hoehe der Zeilen
        sitzen statt bei wenigen Treffern nach unten zu verrutschen.
        QScrollArea scrollt trotzdem, falls mehr Vorschlaege vorhanden sind.
        """
